  ...
  return (
    <header className="flex h-14 items-center gap-4 border-b px-6">
      <div className="flex gap-2 items-center flex-1">
        <h1 className="text-xl">RayQL Studio</h1>
        {selectedSchema && <div className="text-sm">{selectedSchema.name}</div>}
      </div>
      <div className="flex gap-4">
        <a href="https://github.com/harshdoesdev/rayql" target="_blank" rel="noopener noreferrer" className="inline-flex gap-2 text-gray-800 hover:text-black">
